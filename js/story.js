...
const story = {
  ...
  "floor0": {
    ...
    "bg": "elevator_path.png",
    "textBlocks": [
      "The elevator deposits you on the ground floor with a gentle shudder. The lobby stretches out before you, the buffer zone between work and the outside world. The linoleum gleams under institutional lighting, and daylight filters through the glass doors."
    ],
    "choices": [
      {
  ...
  "floor1": {
    ...
    "bg": "elevator_path.png",
    "textBlocks": [
      "The first floor. This corridor always feels quieter than the research floors. The carpet absorbs your footsteps as you pass office doors with their brass nameplates and frosted glass panels. Through one window, you catch a glimpse of the courtyard below, bathed in afternoon light."
    ],
    "choices": [
      {
        "label": "Continue",
  ...
  "GIS_scene": {
    ...
    "choices": [
      ...
      {
        "label": "\"Sorry, I need to say my goodbyes\"",
        "target": "LISA_scene"
      }
    ]
  },
  ...
  "JEN": {
    ...
    "choices": [
      {
        "label": "\"Sure, let's share my snacks!\"",

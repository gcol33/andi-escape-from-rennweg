...
var Logger = (function() {
    ...
    /**
     * Build arguments array for console methods
     * @param {string} module - Module name
     * @param {Array} args - Original arguments
     * @returns {Array}
     */
    function buildArgs(module, args) {
        var result = [formatPrefix(module)];
    ...
    function debug(module) {
        if (!isDevMode()) return;
        var args = buildArgs(module, Array.prototype.slice.call(arguments, 1));
